...
self.addEventListener('activate', (event) => {
  // Prefixed, not just "everything that is not this build". \`caches.keys()\` is scoped to
  // the ORIGIN, and every project Pages site on an account shares one — so an unfiltered
  // sweep deletes the precache of every other app published from the same user.github.io,
  // and nothing about this app looks wrong afterwards.
  event.waitUntil(
    caches
      .keys()
      .then((keys) =>
